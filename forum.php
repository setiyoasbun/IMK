            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Judul Thread...">
                </div>
                <div class="form-group">
                      <label>Isi Thread</label>
                      <textarea class="form-control" rows="3" placeholder="Ketik disini..."></textarea>
                </div>
                <button class="btn btn-primary btn-block"><b>Post</b></button>
                <br></br>  
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td><a href="thread.php">Pembukaan Kelas UPT Bahasa</a></td>
                        <td>Saeful</td>
                        <td>12-02-2016</td>
                        <td>2</td>
                    </tr>
