...
<body class="page-login layout-full">
  ...
  data-animsition-out="fade-out">>
    <div class="page-content vertical-align-middle">
      ...
      <p>Anda masyarakat umum dan tidak punya akun? Register disini!</p>
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="ID" placeholder="Nomor identitas (KTP,Kartu Pelajar,dll)">
        </div>
        <div class="form-group">
		...
		<div class="form-group">
          <label class="sr-only" for="inputAsal">Instansi</label>
          <input type="text" class="form-control" name="Asal" placeholder="Instansi / Kampus / Tempat Pekerjaan">
        </div>		
