    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="box-header with-border">
                  <h3 class="box-title">Posting Informasi</h3>
                </div><!-- /.box-header -->
        <div class="box-body">
        ...
        <div class="form-group">
                      <label>Pengirim Informasi</label>
                      <input type="text" class="form-control" placeholder="Pengirim Informasi...">
        </div>
        <div class="form-group">
                      <label>Konten Informasi</label>
                      <textarea class="form-control" rows="3" placeholder="Ketik disini..."></textarea>
        </div>
        <button class="btn btn-primary pull-right"><b>Post</b></button>
        </div>
        </div>
        </section>
