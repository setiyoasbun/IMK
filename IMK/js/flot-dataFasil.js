...
$(document).ready(function() {
    ...
    function plot() {
        ...
        var options = {
            ...
            tooltip: true,
            tooltipOpts: {
                content: "'%s' pada bulan %x.0 adalah sebanyak %y.0",
                shifts: {
                    x: -60,
                    y: 25
                }
...
$(function() {
	...
	[
		{
			label: "Fasilitas Butuh Perbaikan",
			data: 19
		}, 
		{
			//label: "Wisma 2",
    ...
    var plotObj = $.plot($("#flot-pie-chart"), data, {
        ...
        tooltip: true,
        tooltipOpts: {
            content: "%p.0% kerusakan barang di %s", // show percentages, rounding to 2 decimal places
            shifts: {
                x: 20,
                y: 0
            },
