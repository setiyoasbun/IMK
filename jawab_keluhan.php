          ...
          <div class="box box-widget">
                <div class='box-header with-border'>
                  <div class='user-block'>
                    ...
                    <span class='username'><a href="#">Ahmad Badal</a></span>
                    <span class='description'>19-12-2016 18:00</span>
                  </div><!-- /.user-block -->
                  </div><!-- /.box-header -->
                <div class='box-body'>
                  <!-- post text -->
                  <p>Jelek Sekali UPT Bahasa ini!</p>

                  <span class='pull-right text-muted'>Not Answered</span>
                </div><!-- /.box-body -->
                <div class="box-footer">
                  <form action="#" method="post">
                    ...
                    <div class="img-push">
                      <input type="text" class="form-control input-sm" placeholder="Tekan Enter untuk Membalas Keluhan...">
                    </div>
                  </form>
                </div><!-- /.box-footer -->
              </div><!-- /.box -->
